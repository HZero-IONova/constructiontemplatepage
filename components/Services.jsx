...
const serviceData = [
  ...
  },
  {
    ...
    description:
      "Revitalizing spaces with modern designs and high-quality craftsmanship. Whether upgrading a home or remodeling an office, we brin fresh life to every project.",
    serviceList: [
      "Kitchen Remodel",
      "Basement Finish",
      "Flooring",
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          >
              ...
              {serviceData.map((item) => {
                return (
                  <TabsTrigger
                    key={item.name}
                    value={item.name}
                    className="w-full rounded-none h-[100px] flex items-center relative custom-shadow p-0 outline-none"
                  >
                    <div
            ...
            {/** tabs content */}
            <div className="flex-1 bg-white custom-shadow h-[490px] p-[30px]">
              {serviceData.map((item) => (
                  ...
                  >
                    ...
                    <div>
                      <div>
                        ...
                        <Button text="Read More" targetId="projects" />
                      </div>
                    </div>
                  </motion.div>
                </TabsContent>
